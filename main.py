...
speed_poti = PotiController(pin_num=36, filter_size=5, threshold=1)
light_button = ButtonController(pin_num=LIGHT_BUTTON_PIN, debounce_ms=5)
emergency_button = ButtonController(pin_num=EMERGENCY_BUTTON_PIN, debounce_ms=5)
direction_button = ButtonController(pin_num=DIRECTION_BUTTON_PIN, debounce_ms=5)
sound_button = ButtonController(pin_num=SOUND_BUTTON_PIN, debounce_ms=5)
            ...
            try:
                ...
                while True:
                    ...
                    if timer.is_ready("send_poti_update", POTI_UPDATE_INTERVAL):
                        ...
                        # check direction button(incl. debouncing), toggle direction and set speed to 0, disable speed sending until the
